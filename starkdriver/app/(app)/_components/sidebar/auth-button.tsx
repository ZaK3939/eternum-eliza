...
const AuthButton: React.FC = () => {
  ...
  if (!user || !user.wallet)
    return (
      <SidebarMenu>
        <SidebarMenuItem>
          <SidebarMenuButton variant='brandOutline' onClick={() => login()} className='w-full justify-center gap-0'>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <span className='ml-2'>{truncateAddress(user.wallet.address)}</span>
