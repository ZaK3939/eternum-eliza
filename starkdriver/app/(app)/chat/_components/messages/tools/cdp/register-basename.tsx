...
import type { RegisterBasenameActionResultType } from '@/aitool';
  ...
  return (
    <ToolCard
      ...
      result={{
        ...
        body: (result: RegisterBasenameActionResultType) => (result.body ? result.body.basename : 'No basename found'),
      }}
    />
  );
};
