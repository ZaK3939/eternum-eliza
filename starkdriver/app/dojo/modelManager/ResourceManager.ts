import { getEntityIdFromKeys, gramToKg, multiplyByPrecision } from '../../_hooks/utils/utils';
import { BuildingType, CapacityConfigCategory, ResourcesIds, StructureType, type ID } from '@bibliothecadao/eternum';
import { getComponentValue } from '@dojoengine/recs';
import { configManager, type SetupResult } from '../../_contexts/setup';
...
export class ResourceManager {
  ...
  private _netRate(resourceId: ResourcesIds): [boolean, number] {
    ...
    const consumptionRate = Number(production.consumption_rate);
